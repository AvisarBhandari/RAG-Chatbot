...
**Live:** [Live Demor](https://rag-chatbot-six-zeta.vercel.app/)
...
---
>>>>>>> 1b587fe (fix: Correct environment variable name for API key and add debug prints in embedding service)
